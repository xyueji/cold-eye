define({ "api": [
  ...
  {
    "type": "GET",
    "url": "system/schedule/log/info/{logId}",
    "title": "定时任务日志信息",
    "description": "<p>定时任务日志列表</p>",
    "group": "ScheduleJobLogController",
    "parameter": {
      "examples": [
        {
          "title": "请求示例:",
    ...
    "version": "1.0.0",
    "filename": "cold-eye/cold-eye-jobs/src/main/java/com/xyueji/coldeye/jobs/contoller/ScheduleJobLogController.java",
    "groupTitle": "ScheduleJobLogController",
    "name": "GetSystemScheduleLogInfoLogid"
  },
  {
    "type": "GET",
